...
public enum FMessage implements Message {
    ...
    UI_WAR_OBJECTIVE_OCCUPY_CAPTURE_DISABLED("ui.warObjective.occupyCaptureDisabled"),
    UI_WAR_OBJECTIVE_OCCUPY_CRYSTAL_LOCKED("ui.warObjective.occupyCrystalLocked"),
    ...
    WAR_COMMAND_HEADER("war.command.header"),
    WAR_COMMAND_PHASE("war.command.phase"),
    WAR_COMMAND_SCORE_LINE("war.command.scoreLine"),
    WAR_COMMAND_NEAREST_HINT("war.command.nearestHint"),
    WAR_COMMAND_NEAREST_FIGHT("war.command.nearestFight"),
    WAR_COMMAND_NEAREST_WAYPOINT("war.command.nearestWaypoint"),
    WAR_COMMAND_NEAREST_NONE("war.command.nearestNone"),
    WAR_COMMAND_OBJECTIVE_LINE("war.command.objectiveLine"),
    WAR_CARAVAN_ARRIVED("war.caravan.arrived"),
    WAR_CARRIER_DEPOSIT("war.carrier.deposit"),
    WAR_CARRIER_NO_FACTION("war.carrier.noFaction"),
    WAR_CARRIER_KILLED("war.carrier.killed"),
    WAR_CARRIER_KILLED_HINT("war.carrier.killedHint"),
    WAR_CARRIER_SPAWN("war.carrier.spawn"),
    WAR_END_RANKING("war.end.ranking"),
    WAR_END_WINNER("war.end.winner"),
    WAR_RESPAWN_WAYPOINT("war.respawn.waypoint"),
    WAR_RESPAWN_FACTION_HOME("war.respawn.factionHome"),
    WAR_OBJECTIVE_CLAIMED("war.objective.claimed"),
    WAR_OBJECTIVE_REPAIR_STARTED("war.objective.repair.started"),
    WAR_OBJECTIVE_REPAIR_PROGRESS("war.objective.repair.progress"),
    WAR_OBJECTIVE_UPGRADE_BOUGHT("war.objective.upgrade.bought"),
    WAR_OBJECTIVE_WAYPOINT_ENABLED("war.objective.waypoint.enabled"),
    WAR_OBJECTIVE_WAYPOINT_NOT_SET("war.objective.waypoint.notSet"),
    WAR_OBJECTIVE_WAYPOINT_SET_STATE("war.objective.waypoint.setState"),
    WAR_OBJECTIVE_WAYPOINT_ENABLED_STATE("war.objective.waypoint.enabledState"),
    WAR_OBJECTIVE_WAYPOINT_LOCKED_STATE("war.objective.waypoint.lockedState"),
    WAR_OBJECTIVE_INFO_NAME("war.objective.info.name"),
    WAR_OBJECTIVE_INFO_ALLIANCE("war.objective.info.alliance"),
    WAR_OBJECTIVE_INFO_ALLIANCE_NONE("war.objective.info.allianceNone"),
    WAR_OBJECTIVE_INFO_OWNER("war.objective.info.owner"),
    WAR_OBJECTIVE_INFO_OWNER_NONE("war.objective.info.ownerNone"),
    WAR_OBJECTIVE_INFO_OPERATOR("war.objective.info.operator"),
    WAR_OBJECTIVE_INFO_OPERATOR_NONE("war.objective.info.operatorNone"),
    WAR_OBJECTIVE_INFO_TIER("war.objective.info.tier"),
    WAR_OBJECTIVE_INFO_POINT_VALUE("war.objective.info.pointValue"),
    WAR_OBJECTIVE_INFO_CAPTURE_UNLOCKED_YES("war.objective.info.captureUnlockedYes"),
    WAR_OBJECTIVE_INFO_CAPTURE_UNLOCKED_NO("war.objective.info.captureUnlockedNo"),
    WAR_OBJECTIVE_INFO_CONTESTED_YES("war.objective.info.contestedYes"),
    WAR_OBJECTIVE_INFO_CONTESTED_NO("war.objective.info.contestedNo"),
    WAR_OBJECTIVE_INFO_WAYPOINT_NOT_SET("war.objective.info.waypointNotSet"),
    WAR_OBJECTIVE_INFO_WAYPOINT_SET("war.objective.info.waypointSet"),
    WAR_OBJECTIVE_INFO_WAYPOINT_ENABLED("war.objective.info.waypointEnabled"),
    WAR_OBJECTIVE_INFO_WAYPOINT_LOCKED("war.objective.info.waypointLocked"),
    WAR_OBJECTIVE_INFO_WAYPOINT_AVAILABLE_NOT_SET("war.objective.info.waypointAvailableNotSet"),
    WAR_OBJECTIVE_INFO_WAYPOINT_AVAILABLE_YES("war.objective.info.waypointAvailableYes"),
    WAR_OBJECTIVE_INFO_WAYPOINT_AVAILABLE_NO("war.objective.info.waypointAvailableNo"),
    WAR_OBJECTIVE_INFO_REPAIR_SUPPLIES("war.objective.info.repairSupplies"),
    WAR_OBJECTIVE_INFO_UPGRADES("war.objective.info.upgrades"),
    WAR_OBJECTIVE_INFO_CRYSTALS("war.objective.info.crystals"),
    WAR_OBJECTIVE_DESYTROYED("war.objective.crystal.destroyed"),
    WAR_OBJECTIVE_DESYTROYED_BY_PLAYER("war.objective.crystal.destroyedByPlayer"),
    WAR_OBJECTIVE_CRYSTAL_RECHARGED("war.objective.crystal.recharged"),
    ...
    WAR_PHASE_TRUCE_ANNOUNCEMENT("war.phase.truce.announcement"),
    WAR_PHASE_TRUCE_DISPLAY_NAME("war.phase.truce.displayName"),

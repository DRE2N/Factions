...
public enum FMessage implements Message {
    ...
    BUILDING_CONTAINER_PROTECTED("building.container.protected"),
    BUILDING_TICKET_ACCEPTED("building.ticket.accepted"),
    BUILDING_TICKET_DENIED("building.ticket.denied"),
    BUILDING_TICKET_EMPTY("building.ticket.empty"),
    BUILDING_TICKET_ENTRY("building.ticket.entry"),
    BUILDING_TICKET_HEADER("building.ticket.header"),
    BUILDING_TICKET_INVALID("building.ticket.invalid"),
    BUILDING_TICKET_MISSING_ID("building.ticket.missingId"),
    BUILDING_TICKET_MISSING_MESSAGE("building.ticket.missingMessage"),
    BUILDING_TICKET_TELEPORTED("building.ticket.teleported"),
    BUILDING_UPGRADE_READY("building.upgrade.ready"),
    BUILDING_UPGRADE_IN_PROGRESS("building.upgrade.in_progress"),
    BUILDING_UPGRADE_STARTED("building.upgrade.started"),
    BUILDING_UPGRADE_COMPLETED("building.upgrade.completed"),
    ...
    CMD_REGION_SCHEMATIC_DELETE_SUCCESS("cmd.region.schematic.delete.success"),
    CMD_REGION_SCHEMATIC_LIST_EMPTY("cmd.region.schematic.list.empty"),
    CMD_REGION_SCHEMATIC_LIST_ENTRY("cmd.region.schematic.list.entry"),
    CMD_REGION_SCHEMATIC_LIST_HEADER("cmd.region.schematic.list.header"),
    CMD_REGION_SCHEMATIC_LOAD_STARTED("cmd.region.schematic.load.started"),
    CMD_REGION_SCHEMATIC_LOAD_SUCCESS("cmd.region.schematic.load.success"),
    CMD_REGION_SCHEMATIC_LOAD_FAILED("cmd.region.schematic.load.failed"),
    CMD_REGION_SCHEMATIC_SAVE_STARTED("cmd.region.schematic.save.started"),
    CMD_REGION_SCHEMATIC_SAVE_SUCCESS("cmd.region.schematic.save.success"),
    CMD_REGION_SCHEMATIC_SAVE_FAILED("cmd.region.schematic.save.failed"),
    ...
    ERROR_REGION_SCHEMATIC_STATE_NOT_FOUND("error.regionSchematicStateNotFound"),

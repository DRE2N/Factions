...
public class CreateWarFlagCommand extends FCommand {
    ...
    public void onExecute(CommandSender sender, String[] args) {
        ...
        OccupyWarObjective objective = region.getStructure(args[1], OccupyWarObjective.class);
    ...
    public List<String> onTabComplete(CommandSender sender, String[] args) {
        if (args.length == 2) {
            ...
            return getTabList(region.getStructures(OccupyWarObjective.class).keySet(), args[1]);
        }
        return null;
    }
}

...
public class Regeneration extends BuildingEffect implements Listener {
    private final AttributeModifier modifier;

    public Regeneration(@NotNull BuildingEffectData data, BuildSite site) {
        super(data, site);
        modifier = new AttributeModifier(NamespacedKey.fromString("factions:building-regen"), data.getDouble("amount", 0.1), AttributeModifier.Operation.ADD_NUMBER, EquipmentSlotGroup.ANY);
    }
